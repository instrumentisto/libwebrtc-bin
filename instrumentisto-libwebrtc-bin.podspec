Pod::Spec.new do |spec|
  ...
  spec.version = "126.0.6478.182.rc.1"
  ...
  spec.source = { :http => "https://github.com/instrumentisto/libwebrtc-bin/releases/download/126.0.6478.182.rc.1/libwebrtc-ios.zip" }
