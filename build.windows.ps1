...
Exec { git apply -p1 --ignore-space-change -v $PATCH_DIR\add_licenses.patch }
Write-Output "Applying 4k.patch"
Exec { git apply -p1 --ignore-space-change -v $PATCH_DIR\4k.patch }
...
Exec { git apply -p1 --ignore-space-change -v $PATCH_DIR\windows_fix_abseil.patch }
Write-Output "Applying windows_fix_optional.patch"
Exec { git apply -p1 --ignore-space-change -v $PATCH_DIR\windows_fix_optional.patch }
Write-Output "Applying windows_add_deps.patch"
Exec { git apply -p1 --ignore-space-change -v $PATCH_DIR\windows_add_deps.patch }
